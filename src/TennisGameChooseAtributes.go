...
func main(){
	...
	fmt.Println("Quantidade de Sets para ganhar o Match:")
	fmt.Scanln(&SETSPARAVITORIA)
	fmt.Println("Quantidade de Games dos Sets:")
	fmt.Scanln(&GAMESPARAVITORIA)
	fmt.Println("Quantidade de Pontos dos Games:")
	fmt.Scanln(&PONTOSPARAVITORIA)
	/*
